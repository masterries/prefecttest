...
TABLE_SCHEMAS = {
    "raw_listings": SchemaDatasetFacet(
        fields=[
            SchemaDatasetFacetFields(name="run_id", type="VARCHAR"),
            SchemaDatasetFacetFields(name="guid", type="VARCHAR"),
            SchemaDatasetFacetFields(name="make", type="VARCHAR"),
            SchemaDatasetFacetFields(name="model", type="VARCHAR"),
            SchemaDatasetFacetFields(name="price", type="INTEGER"),
            SchemaDatasetFacetFields(name="mileage", type="INTEGER"),
            SchemaDatasetFacetFields(name="fuel_type", type="VARCHAR"),
            SchemaDatasetFacetFields(name="first_registration", type="VARCHAR"),
            SchemaDatasetFacetFields(name="seller_type", type="VARCHAR"),
            SchemaDatasetFacetFields(name="url", type="VARCHAR"),
            SchemaDatasetFacetFields(name="scraped_at", type="TIMESTAMPTZ"),
        ]
    ),
    ...
    "price_changes": SchemaDatasetFacet(
        fields=[
            SchemaDatasetFacetFields(name="guid", type="VARCHAR"),
            SchemaDatasetFacetFields(name="old_price", type="INTEGER"),
            SchemaDatasetFacetFields(name="new_price", type="INTEGER"),
            SchemaDatasetFacetFields(name="detected_at", type="TIMESTAMPTZ"),
        ]
    ),
}
